...
web_server&   s    
r   Ústart©r   Úmc                 Ã   s6   |j tjttdddgtdddggƒdI d H  d S ) Nu5   âœœ á´€sÊœá´œá´›á´sÊœ É¢á´sá´¡á´€á´Éª ğŸ¸ğŸº âœœzhttps://t.me/chouhanbhai_bot)Úurlu+   ğŸ¦‹ ğ…ğ¨ğ¥ğ¥ğ¨ğ° ğŒğ ğŸ¦‹zhttps://t.me/chouhanbhai_bot)Zreply_markup)Ú
reply_textr   Z
START_TEXTr   r   r   r   r   r   Ú
account_login,   s    ÿÿúÿşr!   Ústopc                 Ã   s0   |  dd¡I d H  tjtjtjgtj¢R   d S )Nu$   â™¦ ğ’ğ­ğ¨ğ©ğ©ğğ­ â™¦T)r    ÚosÚexeclÚsysÚ
...
z://é   uG   âˆ ğˆğ§ğ¯ğšğ¥ğ¢ğ ğŸğ¢ğ¥ğ ğ¢ğ§ğ©ğ®ğ­.u8   ÉªÉ´ á´›xá´› Ò“ÉªÊŸá´‡ á´›Éªá´›ÊŸá´‡ ÊŸÉªÉ´á´‹ ğŸ”—** **uo   **

sá´‡É´á´… Ò“Ê€á´á´  á´¡Êœá´‡Ê€á´‡ Êá´á´œ á´¡á´€É´á´› á´›á´ á´…á´á´¡É´ÊŸá´á´€á´… ÉªÉ´Éªá´›á´€ÊŸ Éªs 1uz   âˆ ğğ¨ğ° ğğ¥ğğšğ¬ğ ğ’ğğ§ğ ğŒğ ğ˜ğ¨ğ®ğ« ğğšğ­ğœğ¡ ğğšğ¦ğZ144Z 256x144Z240Z 426x240Z360Z 640x360Z480Z 854x480Z720Z1280x720Z1080Z	1920x1080ZUNu   ï¸ âªâ¬â®â®â®ZRobinz http://zhttps://zwget 'z' -O 'thumb.jpg'z	thumb.jpgZnoz file/d/zuc?export=download&id=zwww.youtube-nocookie.com/embedzyoutu.bez?modestbranding=1Ú z/view?usp=sharingZ	visioniasz‡text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9zen-US,en;q=0.9zno-cachez
...
Batch Name  Â» Zdrive)Z chat_idZdocumentZ captionz .pdf" "z -R 25 --fragment-retries 25uZ   **âŠâŸ± ğƒğ¨ğ°ğ§ğ¥ğ¨ğšğğ¢ğ§ğ  âŸ±âŠ Â»

ğŸ“ ğğšğ¦ğ Â» u!   
âŒ¨ ğğ®ğ¥ğ¢ğ­ğ² Â» u   

ğŸ”— ğ”ğ‘ğ‹ Â»** `ú`uZ   âŒ˜ ğƒğ¨ğ°ğ§ğ¥ğ¨ğšğğ¢ğ§ğ  ğˆğ§ğ­ğğ«ğ®ğ©ğ­ğğ
u   
âŒ˜ ğğšğ¦ğ Â» u   
âŒ˜ ğ‹ğ¢ğ§ğ¤ Â» uE   âœ… ğ’ğ®ğœğœğğ¬ğ¬ğŸğ®ğ¥ğ¥ğ² ğƒğ¨ğ§ğ),r    r	   ZchatÚidr@   ÚdeleteÚopenÚreadÚsplitÚappendr#   ÚremoveZeditÚlenÚtextr   Z Q1_TEXTÚ	ExceptionZ C1_TEXTZ T1_TEXTÚ
startswithr
